                                                                                    ...
                                                                                    children: <
                                                                                      ...
                                                                                      Container(
                                                                                        ...
                                                                                        child:
                                                                                          ...
                                                                                          children: <
                                                                                              Widget>[
                                                                                            Text("${orderStock[i]["stockData"][a]["normalPrice"]}".substring(0,
                                                                                                orderStock[i]["stockData"][a]["normalPrice"].toString().lastIndexOf("."))),
                                                                                            Padding(
                                                                    ...
                                                                    children: <
                                                                      ...
                                                                      Container(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: <
                                                                              Widget>[
                                                                            Text("${returnStock[i]["stockData"][a]["normalPrice"]}".substring(0,
                                                                                returnStock[i]["stockData"][a]["normalPrice"].toString().lastIndexOf("."))),
                                                                            Padding(
                                                                              padding: const EdgeInsets.only(right: 15),
                                                                              child: Text(
                                  ...
                                  final now = DateTime.now();
                                      ...
                                      for (var a = 0; a < getinvoiceOrderlist.length; a++) {
                                        for (var b = 0; b < getinvoiceOrderlist[a]["stockData"].length; b++) {
                                          ...
                                          detail.add({
                                            "stkDesc": "${getinvoiceOrderlist[a]["stockData"][b]["stockName"]}",
                                            "totalqty": "${getinvoiceOrderlist[a]["stockData"][b]["qty"].toInt()}",
                                            "discount":"${getinvoiceOrderlist[a]["stockData"][b]["discountPercent"]}",

                                            "price": getinvoiceOrderlist[a]["stockData"][b]["price"].toString().substring(getinvoiceOrderlist[a]["stockData"][b]["price"].toString().lastIndexOf("."), getinvoiceOrderlist[a]["stockData"][b]["price"].toString().length).length > 3 ?
                                        ...
                                        for (var b = 0; b < getinvoiceOrderlist[a]["stockReturnData"].length; b++) {
                                          ...
                                          detail.add({
                                            "stkDesc": "${getinvoiceOrderlist[a]["stockReturnData"][b]["stockName"]}",
                                            "totalqty": "-${getinvoiceOrderlist[a]["stockReturnData"][b]["qty"].toInt()}",
                                            "discount":"${getinvoiceOrderlist[a]["stockReturnData"][b]["discountPercent"]}",

                                            "price": getinvoiceOrderlist[a]["stockReturnData"][b]["price"].toString().substring(getinvoiceOrderlist[a]["stockReturnData"][b]["price"].toString().lastIndexOf("."), getinvoiceOrderlist[a]["stockReturnData"][b]["price"].toString().length).length > 3 ?
